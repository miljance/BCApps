...
table 8060 "Billing Template"
{
    ...
    begin
        if Automation <> Automation::None then
            if not AutoContractBillingAllowed then
    ...
    begin
        ...
        BillingProposal.CreateBillingProposal(Code, BillingDate, BillingToDate);
        BillingLine.Reset();
        ...
        if not BillingLine.IsEmpty then begin
            ...
            CreateBillingDocuments.SetAutoContractBilling(true);
    ...
    begin
        ...
        exit(UserSetup."Auto Contract Billing");
    end;
}