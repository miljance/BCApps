...
tableextension 8054 "Sales Line" extends "Sales Line"
{
    ...
    /// <summary>
    /// Returns the Subscription Contract that this sales line bills, if any.
    /// </summary>
    /// <remarks>
    ...
    begin
        ...
        BillingDocumentType := BillingLine.GetBillingDocumentTypeFromSalesDocumentType(Rec."Document Type");
